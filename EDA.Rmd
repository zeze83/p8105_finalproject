...
#>>>>>>> 5efc80d7ce17eab832bfc61ec2475e0637504a8b
...
#### R Table test for P-value function
```{r}
pvalue <- function(x, ...) {
...
# In order to visualize the intercorrelation between different variables. We do a correlation heat map.
```{r}
...
# Replace 'diabetes_data' with your actual data frame name
