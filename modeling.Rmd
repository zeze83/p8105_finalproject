...
```{r}
model <- glm(Diabetes_012 ~ HighBP + HighChol + BMI + Smoker + HeartDiseaseorAttack + Sex + Income + Education + PhysActivity + Fruits + Veggies + Age + HvyAlcoholConsump, data = diabetes_data01)
summary(model)
